    ...
    <div>
      <div class="items flex justify-between items-start xl:items-center flex-col xl:flex-row">
        ...
        <div class="text-section">
          <span><?= __('Turn on high contrast mode to make our website more', 'covid-circle-wp') ?> <a href="<?= get_permalink(get_page_by_path('accessibility')) ?>">accessible.</a></span> <div id="accessibility"></div>
        </div>
      </div>
    </div>
  </div>
