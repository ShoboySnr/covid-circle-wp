...
class FrontPage extends Controller
{
    ...
    public static function get_news_and_events()
    {
        ...
        if ($stickyposts->have_posts()) {
            foreach ($stickyposts->posts as $key => $value) {
                if (is_sticky($value->ID)) {
                    ...
                    $sticky_news_events[$key]['title']    = Utility::limitStr($value->post_title, 70);
        ...
        foreach ($posts->posts as $key => $value) {
            ...
            $news_events[$key]['title']    = Utility::limitStr($value->post_title, 70);;
    ...
    {
        return [
            'section_one_image' => get_field('sectionone_image', $frontpage_id),
